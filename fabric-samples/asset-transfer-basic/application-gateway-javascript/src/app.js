    ...
    try {
        ...
        app.post('/createasset', async(req,res)=> {
            const asset = {
                ...
                unsellable: req.body.unsellable
            }

            await createAsset(contract, asset);
            res.send("Successfully created the asset");
        })

        app.post('/swapasset', async(req,res)=> {
            const asset1 = req.body.asset1;
            const asset2 = req.body.asset2;

            await SwapAsset(contract, asset1, asset2);
            res.send('Successfully swap owner of ${asset1} and  ${asset2}');
        })
 ...
 */
async function createAsset(contract, asset) {
    console.log(
...
async function SwapAsset(contract, asset1, asset2) {
    console.log("\n\n\nSwapping Asset Initialization\n\n\n");
    try {
        await contract.submitTransaction(
            'SwapAsset',
            asset1,
        ...
        console.log("\n\nSwapping Asset Successfull\n\n\n");
    }
    catch {
        console.log("\n\nSwapping Asset not Successfull\n\n\n");
    }
}

async function SellAsset(contract) {
    console.log("\n\n\n Sell Asset Initialization\n\n\n");
